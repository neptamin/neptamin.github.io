...
NotebookDataLength[     22632,        621]
NotebookOptionsPosition[     22622,        596]
NotebookOutlinePosition[     23147,        619]
CellTagsIndexPosition[     23104,        616]
WindowFrame->Normal*)
...
Cell[CellGroupData[{
Cell["Visualizing Spherical Coordinates", "Section", "PluginEmbeddedContent"],

Cell[BoxData[Cell[TextData[{
  "1. The surface corresponding to constant ",
  Cell[BoxData[
   FormBox[
    RowBox[{"\[Rho]", "=", "4."}], TraditionalForm]]]
 }], "Text",
  CellChangeTimes->{{3.716502729994681*^9, 3.716502772016509*^9}}]], "Text", \
"PluginEmbeddedContent"],

Cell[TextData[{
 "\n2. The surface corresponding to constant ",
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Theta]", "=", 
    RowBox[{
...
WindowSize->{674., 2279.08},
Visible->True,
AuthoredSize->{674, 2279},
...
Notebook[{
Cell[CellGroupData[{
Cell[1486, 35, 77, 0, 38, "Section"],
Cell[1566, 37, 274, 7, 21, "Text"],
Cell[1843, 46, 261, 8, 41, "Text"],
Cell[CellGroupData[{
Cell[2129, 58, 3517, 99, 186, "Input"],
Cell[5649, 159, 3150, 70, 512, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[8836, 234, 3502, 98, 186, "Input"],
Cell[12341, 334, 3164, 70, 512, "Output"]
}, Open  ]],
Cell[15520, 407, 325, 9, 44, "Text"],
Cell[CellGroupData[{
Cell[15870, 420, 3547, 100, 186, "Input"],
Cell[19420, 522, 3174, 70, 512, "Output"]
}, Open  ]]
}, Open  ]]
}
]
...
(* NotebookSignature dvDo4QOnitwhTCKRwI7NMEAF *)
